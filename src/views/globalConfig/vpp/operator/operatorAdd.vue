  ...
  <div class="pt-5 pb-8 add-operator">
    ...
    >
      ...
      <el-form-item prop="industryCategory">
        ...
        <el-select v-model="form.industryCategory" placeholder="请选择行业分类" clearable style="width: 100%">
      ...
      <el-form-item prop="enterpriseAddress">
        ...
        <el-input v-model="form.enterpriseAddress" placeholder="请输入详细地址" maxlength="200" />
      </el-form-item>
