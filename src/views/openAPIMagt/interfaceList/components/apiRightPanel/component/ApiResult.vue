        ...
        <div class="result-section">
          ...
          <div class="json-box">
            <el-button
              link
              type="primary"
              @click="copyJson(result.response, '响应结果')"
              class="copy-btn"
            >
        ...
        <div class="result-section">
          ...
          <div class="json-box">
            <el-button
              link
              type="primary"
              @click="copyJson(result.responseHeaders, '响应头')"
              class="copy-btn"
            >
              <el-icon><CopyDocument /></el-icon>复制
            </el-button>
        ...
        <div class="result-section">
          ...
          <div class="json-box">
            <el-button
              link
              type="primary"
              @click="copyJson(result.requestHeaders, '请求头')"
              class="copy-btn"
            >
              <el-icon><CopyDocument /></el-icon>复制
            </el-button>
        ...
        <div class="result-section">
          ...
          <div class="json-box">
            <el-button
              link
              type="primary"
              @click="copyJson(result.request, '请求内容')"
              class="copy-btn"
            >
              <el-icon><CopyDocument /></el-icon>复制
            </el-button>
