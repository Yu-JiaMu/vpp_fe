...
watch(() => props.appKey, val => { authModel.appKey = val })
watch(() => props.appSecret, val => { authModel.appSecret = val })
watch(() => authModel.appKey, val => emit('update:appKey', val))
watch(() => authModel.appSecret, val => emit('update:appSecret', val))
...
.params-form {
  ...
  .params-section { margin-bottom: 24px; padding-right: 16px; }
}
